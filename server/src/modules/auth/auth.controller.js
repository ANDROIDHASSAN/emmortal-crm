...
import { verifyPassword, createUser } from './auth.service.js';
import {
  signAccess,
  signRefresh,
  verifyRefresh,
...
function setAuthCookies(res, user) {
  ...
  const refresh = signRefresh(user, user.tokenVersion || 0);
...
export const refresh = asyncHandler(async (req, res) => {
  ...
  // Rotate: bump tokenVersion so the old refresh token can't be reused.
